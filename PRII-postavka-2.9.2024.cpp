...
class Igrac {
	...
	GenerisiID tj.atributa _imePrezime(inicijala imena i prezimena) i
		statickog clana _id
		char* _imePrezime;
...
void main() {
	...
	*/
	...
	try
	{
		BIH.AddIgrac(denis);//onemoguciti dodavanje istih igraca -
		provjeravati ID
	}
	catch (exception& obj)
	{
	...
	try
	{
		euro2024.AddUtakmicu(BIH, ENG);//onemoguciti ponovne susrete
		drzava tokom istog prvenstva
	}
	catch (exception& obj)
	{
		cout << obj.what();
