...
const char* GetOdgovorNaPrvoPitanje() {
    cout << "Pitanje -> Pojasnite STACK i HEAP dio memorije, za šta su namijenjeni, te na koji na?in se trebaju koristiti (prednosti i nedostaci pojedinih slu?ajeva).\n";
